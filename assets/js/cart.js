...
(function(){
    ...
    function loadNewsletter(){
        ...
        var s = document.createElement("script");
        s.src = "assets/js/newsletter.js?v=11";
        s.defer = true;
    ...
    function loadMotion(){
        // Site-wide reveal layer: sectional fade-up + the story
        // timeline date-ticker. Skips itself under reduced-motion.
        if (document.querySelector('script[data-roux-motion]')) return;
        var s = document.createElement("script");
        s.src = "assets/js/motion.js?v=11";
        s.defer = true;
        s.setAttribute("data-roux-motion", "");
        document.body.appendChild(s);
    }
    ...
    function loadResponsivePolish(){
        ...
        ["polish-desktop", "polish-mobile", "polish-home"].forEach(function(name){
            ...
            l.rel = "stylesheet";
            l.href = "assets/css/" + name + ".css?v=11";
